...
global._getFields = function (schema, fieldShows) {
    ...
    _.forEach(fieldShows, function (item) {
        if (_.has(schema.schema.paths, item.field)) {
            ...
            }else if (_.isEqual(field.instance, 'Date') && _.isEqual(item.field, 'timeStart' )) {
                field.instance = 'Time';
            }
